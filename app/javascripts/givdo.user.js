(function () {
  ...
  angular
    ...
    function FriendShowCtrl($cordovaKeyboard, $scope, $state,
                            $http, $cordovaFacebook, $stateParams,
                            givdo, sessionService) {
      ...
      givdo.user.get_friend($stateParams.friendId).then(function(friend){
        ...
        var url_cover = 'https://graph.facebook.com/' +
                        friend.attr('uid') +
